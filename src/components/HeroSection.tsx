    ...
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            <span className="text-gradient-gold">Eumentis</span> Real Estate
            <br />
          ...
          <p
            className={`text-lg md:text-xl lg:text-2xl mb-8 max-w-2xl mx-auto leading-relaxed text-gray-200 ${
              isLoaded ? "hero-text" : "opacity-0"
            }`}
            style={{ animationDelay: "0.6s" }}
          >
            Discover premium properties and investment opportunities with
            Eumentis, your trusted partner in luxury real estate.
          </p>
